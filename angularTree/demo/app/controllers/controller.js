treeApp.controller('TreeController', ['$scope', function ($scope) {
    ...
    function init() {
        $scope.treeNodes = [{
            ...
            children: [{
                name: "A list of all Mortgage Cases",
                image: "app/images/disk.png",
                children: [
                    {
                        name: "Case Details",image: "app/images/disk.png",
                        children:[
                            { name: "There can be only one mortgage case - Mortgage Details", image: "app/images/disk.png" },
                        ]
                    ...
                    },
                    {
                        name: "Property",
                        children: [
                            { name: "There can be only one property - Property Details", image: "app/images/movie.png" },
                        ]
                    },
                    {
                        name: "Applicants",
                        children: [
                            { name: "Applicant 1 ",image: "app/images/sea.png" },
                            { name: "Applicant 2 ",image: "app/images/sea.png" },
                            { name: "There can be many applicants ",image: "app/images/sea.png" },
                    ...
                    },
                    {
                        name: "Loan",
                        children: [
                            {name: "Mortgage 1", image: "app/images/pdf.png"}, 
                            {name: "Mortgage 2", image: "app/images/pdf.png"},
                            {name: "There can be many Mortgages to select from", image: "app/images/pdf.png"},          
                        ]
                    }
                ]
           },
           {
                ...
                children: [
                    {
                        name: "Case 2 Details",image: "app/images/disk.png",
                        children:[
                            { name: "There can be only one mortgage case - Mortgage Details", image: "app/images/disk.png" },
                        ]
                    ...
                    },
                    {
                        name: "Applicants",
                        children: [
                            { name: "Applicant 2.1 ",image: "app/images/sea.png" },
                            { name: "Applicant 2.2 ",image: "app/images/sea.png" },
                            { name: "There can be many applicants ",image: "app/images/sea.png" },
           ...
           {
                name: "There are Many Mortgage Cases",
                image: "app/images/disk.png",
                children: [
                    {
                        name: "Case 3 Details",image: "app/images/disk.png",
                        children:[
                            { name: "There can be only one mortgage case - Mortgage Details", image: "app/images/disk.png" },
                        ]
                    ...
                    },
                    {
                        name: "Applicants",
                        children: [
                            { name: "Applicant 3.1 ",image: "app/images/sea.png" },
                            { name: "There mudt be one applicant ",image: "app/images/sea.png" },
